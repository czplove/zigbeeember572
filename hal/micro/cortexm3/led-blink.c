...
static HalBoardLedPins_t activeLed[MAX_LED_NUMBER] = {BOARDLED0, BOARDLED1};
...
static HalBoardLedPins_t activeLed[MAX_LED_NUMBER] = {BOARDLED0};
#endif
...
{
  activeLed[0] = (HalBoardLedPins_t)led;
}
...
void halMultiLedBlinkSetActivityLeds(uint8_t led)
{
  ...
  activeLed[ledSequence] = (HalBoardLedPins_t)led;
  ledSequence++;

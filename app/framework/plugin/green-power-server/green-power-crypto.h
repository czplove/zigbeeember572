...
bool emZigbeeProApsEncryptPacket(PacketHeader header, 
                                    uint8_t authenticationStartIndex,
                                    uint8_t auxFrameIndex);

// Functions for both APS and NWK decrypt
bool emZigbeeProDecryptPacket(PacketHeader header,
                                 uint8_t authenticationStartIndex,
                                 uint8_t auxFrameIndex,
...
// NWK encrypt only
void emZigbeeProNetworkEncryptFlatPacket(uint8_t* packet,

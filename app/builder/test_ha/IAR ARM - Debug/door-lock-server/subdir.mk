...
C_SRCS += \
F:/githublocally/zigbeeember572/app/framework/plugin/door-lock-server/door-lock-server.c 

OBJS += \
./door-lock-server/door-lock-server.o 

C_DEPS += \
./door-lock-server/door-lock-server.d 
